package by.it.sc02_morning.bondarenko.lesson13;
...
public class TaskB1 {
    ...
    public static void main(String[] args) {
        ...
        Salary arr = new Salary(salary);

        System.out.println(Arrays.toString(arr.getSalary()));
        System.out.println(arr.getSum());
        System.out.println(Arrays.toString(arr.getSalary(20)));
        System.out.println(arr.getSum(20));
        arr.setSalary(50);
        arr.sort();
        System.out.println(Arrays.toString(arr.getSalary()));
        System.out.println(arr.getSum());
