...
public class A_QSort {
    //отрезок
    private class Segment  implements Comparable<by.it.sc02_morning.sabitova.lesson12.A_QSort.Segment>{
        int start;
        int stop;
        ...
        @Override
        public int compareTo(by.it.sc02_morning.sabitova.lesson12.A_QSort.Segment otherSegment) {
    ...
    int[] getAccessory(InputStream stream) throws FileNotFoundException {
        ...
        by.it.sc02_morning.sabitova.lesson12.A_QSort.Segment[] segments = new by.it.sc02_morning.sabitova.lesson12.A_QSort.Segment[n];
        //число точек
        ...
        for (int i = 0; i < n; i++) {
            ...
            segments[i] = new by.it.sc02_morning.sabitova.lesson12.A_QSort.Segment(scanner.nextInt(),scanner.nextInt());
        }
        ...
        for (int i = 0; i < points.length; i++) {
            if (points[i] >= segments[j].start && points[i] <= segments[j].stop) result[i] = 1;
            else {
                result[i] = 0;
                j++;
            }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        by.it.sc02_morning.sabitova.lesson12.A_QSort instance = new by.it.sc02_morning.sabitova.lesson12.A_QSort();
