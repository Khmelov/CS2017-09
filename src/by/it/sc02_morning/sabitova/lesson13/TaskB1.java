...
//массив double[]
//массив String[]
//произвольное количество чисел типа double
//каждый такой конструктор сохраняет данные в приватный массив класса salary
...
public class TaskB1 {
    ...
    public static void main(String[] args) {
        ...
        by.it.sc02_morning.sabitova.lesson13.Salary instance = new by.it.sc02_morning.sabitova.lesson13.TaskB1().newSalary(salary);
    ...
    public by.it.sc02_morning.sabitova.lesson13.Salary newSalary(double[] salary) {
        return new by.it.sc02_morning.sabitova.lesson13.Salary(salary);
    }
}
class Salary {
    ...
    double[] getSalary(double percent) {
        ...
        for (int i = 0; i < salaryPercent.length; i++) {
            salaryPercent[i] = Math.ceil(salary[i] * (1 + percent/100)* 10) / 10;
        }
