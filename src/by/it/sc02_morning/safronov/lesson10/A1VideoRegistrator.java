...
public class A1VideoRegistrator {
    ...
    public static void main(String[] args) {
        ...
        List<Double> starts=instance.calcStartTimes(events,workDuration); //рассчитаем моменты старта, с длиной сеанса 1

        System.out.println(starts);//покажем полученные моменты старта
    }
