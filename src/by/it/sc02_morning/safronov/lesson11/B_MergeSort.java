package by.it.sc02_morning.safronov.lesson11;
...
public class B_MergeSort {
    ...
    private int[] mergeSort(int[] mas,int left,int right){
        if(left==right){
            int [] one = new int[1];
            one [0]=mas[left]; //либо right, без разницы
            return one;
        }
        ...
        //а можно через очереди начиная с if(left==right){ и до сюда
        return result;
    }
...
a=mergeSort(a,0,a.length-1);
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        InputStream stream = new FileInputStream(root + "by/it/sc02_morning/safronov/lesson11/dataB.txt");
