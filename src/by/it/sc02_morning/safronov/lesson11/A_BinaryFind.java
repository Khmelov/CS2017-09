...
int index= Arrays.binarySearch(a,value); //это нужно записать как на доске
if(index<0)
    result[i]=-1;
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        InputStream stream = new FileInputStream(root + "by/it/sc02_morning/safronov/lesson11/dataA.txt");
