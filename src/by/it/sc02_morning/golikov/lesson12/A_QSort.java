...
// решить сколько камер включено на отрезке. это реализовать. это последняя строчка result[1, 0, 0]
        //!!!!!!!!!!!!!!!!!!!!!!!!!     КОНЕЦ ЗАДАЧИ     !!!!!!!!!!!!!!!!!!!!!!!!!
        return result;
    }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        InputStream stream = new FileInputStream(root + "by/it/sc02_morning/golikov/lesson12/dataA.txt");
