package by.it.sc04_evening_tue_thu.shinkevich.lesson12;
...
// Events points+segments
    ...
    int[] getAccessory(InputStream stream) throws FileNotFoundException {
       ...
       int counterEvents=0;
        ...
        Arrays.sort(events);
        System.out.println("Sorted points="+ Arrays.toString(events));
        ...
        else camOn = camOn+events[i].type;
        }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        InputStream stream = new FileInputStream(root + "by/it/sc04_evening_tue_thu/shinkevich/lesson12/dataA.txt");
