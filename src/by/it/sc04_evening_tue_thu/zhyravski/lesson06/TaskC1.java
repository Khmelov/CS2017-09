...
public class TaskC1 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String oneInt = String.format(format, Integer.toBinaryString(1)).replace(' ', '0');
        ...
        for (int i = 0; i < n; i++) {
            ...
            long res = firstNum << 1;
            String binRes = String.format(format, Long.toBinaryString(res)).replace(' ', '0');

            System.out.println(binRes + " = " + res);
